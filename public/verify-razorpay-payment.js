...
module.exports = async function handler(req, res) {
  ...
  const { razorpay_order_id, razorpay_payment_id, razorpay_signature, user_id, user_email } = req.body;
  const template_type = aliases[req.body.template_type] || req.body.template_type;
